...
type GetStudentServiceRes struct {
	Id              string  `json:"id"`
...
type GetStudentServiceStmt struct {
	conn      *sqlite.Conn
	stmt      *sqlite.Stmt
	querySQL  string
	hasSlices bool
...
func GetStudentService(tx *sqlite.Conn) *GetStudentServiceStmt {
	const querySQL = `
SELECT 
	id, 
	student_id, 
...
func (ps *GetStudentServiceStmt) Run(
	id string,
) (
	res *GetStudentServiceRes,
	err error,
) {
