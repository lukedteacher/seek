...
type GetStudentBookmarkRes struct {
	Id         string `json:"id"`
...
type GetStudentBookmarkParams struct {
	UserId    string `json:"user_id"`
	StudentId string `json:"student_id"`
}

type GetStudentBookmarkStmt struct {
	conn      *sqlite.Conn
	stmt      *sqlite.Stmt
	querySQL  string
	hasSlices bool
...
func GetStudentBookmark(tx *sqlite.Conn) *GetStudentBookmarkStmt {
	const querySQL = `
SELECT
	s.id,
	s.marss_id,
...
func (ps *GetStudentBookmarkStmt) Run(
	params GetStudentBookmarkParams,
) (
	res *GetStudentBookmarkRes,
	err error,
) {
