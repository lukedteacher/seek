...
type IEPCSVRow struct {
	...
	StudentMARSSID         CSVMARSSID `json:"student_marss_id" csv:"student_id"`
...
type CSVMARSSID string

func (mid *CSVMARSSID) UnmarshalCSV(csv string) error {
	csv = strings.TrimSpace(csv)
	*mid = CSVMARSSID(strings.TrimLeft(csv, "0"))
	return nil
}

func (mid CSVMARSSID) String() string {
	return string(mid)
}
...
func NewModelFromCSVRow(r IEPCSVRow) IEP {
	...
	return IEP{
		...
		StudentMARSSID:         r.StudentMARSSID.String(),
