...
func DeletePeriodCommandHandler(ctx context.Context, command DeletePeriodCommand, saver eventstore.Saver, retriever eventstore.Retriever) (DeletePeriodResult, error) {
