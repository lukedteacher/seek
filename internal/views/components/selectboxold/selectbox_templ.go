...
func Select(props ...Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 171, Col: 11}
		}
		...
		if p.Name != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 173, Col: 16}
			}
		...
		if p.Value != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 176, Col: 18}
			}
		...
		if p.Form != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 179, Col: 16}
			}
		...
		if p.DataBind != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 188, Col: 25}
			}
		...
		if p.DataOnChange != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 191, Col: 70}
			}
		...
		if p.Class != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 1, Col: 0}
			}
		...
		if p.SelectedContent != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 204, Col: 24}
			}
		...
		if p.Placeholder != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 209, Col: 26}
			}
...
func Option(selected bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/selectboxold/selectbox.templ`, Line: 218, Col: 11}
		}
