	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.Href != "" && !p.Disabled {
			...
			if p.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/components/button/button.templ`, Line: 61, Col: 13}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/components/button/button.templ`, Line: 63, Col: 31}
			}
			...
			if p.Target != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/components/button/button.templ`, Line: 65, Col: 21}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/components/button/button.templ`, Line: 1, Col: 0}
			}
			...
			if p.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/components/button/button.templ`, Line: 87, Col: 13}
				}
			...
			if p.Type != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/components/button/button.templ`, Line: 103, Col: 25}
				}
			...
			if p.Form != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/components/button/button.templ`, Line: 106, Col: 17}
				}
...
func (b Props) variantClasses() string {
	...
	case VariantDestructive:
		return "btn-destructive text-white shadow-xs focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60"
	case VariantOutline:
	...
	case VariantGhost:
		return "hover:bg-primary/90 active:bg-primary hover:text-primary-foreground dark:hover:bg-primary/50"
	case VariantLink:
		return "text-primary underline-offset-4 hover:underline"
	default:
		return "bg-neutral-bright text-neutral-foreground shadow-xs hover:bg-primary/80 active:bg-primary/90"
	}
}
...
func (b Props) sizeClasses() string {
	...
	case SizeIcon:
		return "size-9"
	default: // SizeDefault
		return "h-md px-4 py-2 has-[>svg]:px-3"
	}
}
